import { BaseObject, inspect, Null, objectOf } from './base.mjs';
...
export class UnboundMorph extends Morph {
  static init(morphClass, ...args) {
    return new this(morphClass, args);
  }
